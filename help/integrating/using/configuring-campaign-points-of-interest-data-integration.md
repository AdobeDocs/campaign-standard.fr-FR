...
1. Définissez vos **[!UICONTROL Points ciblés]** dans Places. Voir [Création d'un point ciblé](https://docs.adobe.com/content/help/en/places/using/poi-mgmt-ui/create-a-poi-ui.html).
