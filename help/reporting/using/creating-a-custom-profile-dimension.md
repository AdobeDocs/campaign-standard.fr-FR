...
1. À partir de l'onglet **[!UICONTROL Structure de données]**, dans la catégorie **[!UICONTROL Champs], cliquez sur le bouton** Ajouter un champ **.**

   ![](assets/custom_profile_2.png)

1. Enter the **[!UICONTROL Label]**, **[!UICONTROL ID]** and select the custom resource **[!UICONTROL Type]**. Ici, nous avons sélectionné **[!UICONTROL Texte]puisque les destinataires auront à choisir entre or, argent et bronze.**

   ![](assets/custom_profile_3.png)

1. Cliquez sur l'icône ![ pour définir votre champ.](assets/custom_profile_22.png)
...
1. Enter the **[!UICONTROL Label]** and **[!UICONTROL Value]** then click **[!UICONTROL Add]**. Pour cet exemple, nous devons créer la valeur or, argent et bronze. Une fois terminé, cliquez sur **[!UICONTROL Confirmer].**

   ![](assets/custom_profile_14.png)

1. Sélectionnez l'onglet **[!UICONTROL Définition des écrans].** Dans le menu déroulant **[!UICONTROL Configuration de l'écran de détail]**, cochez la section **Ajouter des champs personnalisés]pour créer une section dans notre profil.[!UICONTROL **

   ![](assets/custom_profile_4.png)

1. Cliquez sur le bouton **[!UICONTROL Ajouter un élément]pour créer une section.** Select the **[!UICONTROL Type]**: **[!UICONTROL Input field]**, **[!UICONTROL Value]** or **[!UICONTROL List]**, then the field to add in this new section.
...
1. Cliquez sur **[!UICONTROL Préparer la publication]** puis, une fois la préparation terminée, cliquez sur le bouton **Publier[!UICONTROL .]**
...
1. Depuis l'onglet **[!UICONTROL Rapports]**, sélectionnez un rapport aux paramètres d'usine et cliquez sur le bouton **Créer]pour en lancer un à partir de zéro.[!UICONTROL **
...
1. Faites glisser et déposez les mesures **[!UICONTROL Traités/envoyés]** et **Ouverts]pour commencer à filtrer vos données.[!UICONTROL **
