...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> Profil<br /> </td> 
   <td> Regroupe les champs de profil personnalisés et d'usine créés lors de l'extension de la ressource de profil. Pour plus d'informations, consultez cette <a href="../../developing/using/key-steps-to-add-a-resource.md">page</a> ou cet <a href="../../reporting/using/creating-a-custom-profile-dimension.md">exemple</a>.<br /> Notez que les données de cette dimension sont récupérées dès que la ressource personnalisée liée au champ de profil est publiée.<br /> </td> 
  </tr> 
  <tr> 
