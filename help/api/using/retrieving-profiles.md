...
En outre, les API des Campaign Standards vous permettent de rechercher des profils en fonction de l’un de ces champs : e-mail, prénom, nom ou tout champ personnalisé. Voir à ce propos [cette section](#searching-field).
...
## Recherche de profils sur la base d’un champ {#searching-field}

Le paramètre **[!UICONTROL filterType]** permet de récupérer des profils en fonction de l&#39;un de ces champs : e-mail, prénom, nom ou tout champ personnalisé ajouté dans le filtrage avancé lors de l’extension de la ressource profil.
...
* Exemple de demande de filtrage des profils sur la base du courriel.
