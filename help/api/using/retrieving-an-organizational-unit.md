---
title: Récupération de l’unité d’organisation d’un profil
description: Découvrez comment utiliser l’unité d’organisation d’un profil avec les API.
...
# Récupération de l’unité d’organisation d’un profil {#retrieving-organizational-units}
