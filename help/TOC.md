...
+ Reporting {#reporting}
   ...
   + Liste des rapports {#list-of-reports}
      ...
      + [Echecs et bounces](reporting/using/non-deliverables-and-bounces.md)
...
+ Intégration avec d&#39;autres solutions {#integrating-with-adobe-cloud}
   ...
   + Campaign et Experience Manager {#working-with-campaign-and-experience-manager}
      ...
      + [Création d’un contenu d’email dans Adobe Experience Manager](integrating/using/creating-email-experience-manager.md)
...
+ Gestion des processus et des données {#managing-processes-and-data}
   ...
   + Cas pratiques {#workflow-use-case}
      ...
      + Diffusions {#deliveries}
         ...
         + [Identifier des doublons avant une diffusion](automating/using/identifying-duplicated-before-delivery.md)
         + [Diffusion d’anniversaire](automating/using/birthday-delivery.md)
         + [Diffusions conjointes d’emails et de courriers](automating/using/coupling-email-direct-mail.md)
         + [Envoi d’un email contenant des champs enrichis](automating/using/sending-email-enriched-fields.md)
         + [Personnaliser un email avec des données additionnelles](automating/using/personalizing-email-with-additional-data.md)
