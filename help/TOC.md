...
+ Canaux de communication {#communication-channels}
   ...
   + Bonnes pratiques de diffusion {#delivery-bestpractices}
      ...
      + [Optimisez votre diffusion](sending/using/optimize-delivery.md)
      + [Utilisez les modèles](sending/using/use-templates.md)
      + [Créer du contenu personnalisé](sending/using/design-and-personalize.md)
      + [Définir l’audience appropriée](sending/using/define-the-right-audience.md)
      + [Vérifier avant envoi](sending/using/check-before-sending.md)
   ...
   + Messages transactionnels {#transactional-messaging}
      ...
      + [Meilleures pratiques en matière de messagerie transactionnelle](channels/using/transactional-messaging-limitations.md)
      + Configuration de l&#39;événement {#event-configuration}
