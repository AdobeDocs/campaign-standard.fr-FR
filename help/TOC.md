...
+ Getting started {#getting-started}
   ...
   + Gestion des modèles {#managing-templates}
      + [Modèles](start/using/about-templates.md)
      + [Créer un modèle](start/using/creating-a-new-template.md)
      + [Créer un modèle multilingue](start/using/creating-a-multilingual-template.md)
      + [Utiliser un modèle](start/using/using-a-template.md)
   + Tutoriels {#tutorials}
...
+ Integrating with Adobe Cloud {#integrating-with-adobe-cloud}
   ...
   + Utilisation de Campaign et Analytics {#working-with-campaign-and-analytics}
   ...
   + Utilisation de Campaign et Audience Manager ou People core service {#working-with-campaign-and-audience-manager-or-people-core-service}
...
+ Developing {#developing}
   ...
   + Ajouter ou étendre une ressource {#adding-or-extending-a-resource}
      + [Principales étapes pour ajouter une ressource](developing/using/key-steps-of-adding-a-resource.md)
...
+ Administrating {#administrating}
   ...
   + Utilisateurs et sécurité {#users-and-security}
      ...
      + [Types d'utilisateurs](administration/using/types-of-users.md)
