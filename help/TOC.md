...
+ Notes de mise à jour {#release-notes}
   ...
   + Versions précédentes {#previous-releases}
      + [Notes de mise à jour 2022](rn/using/release-notes-2022.md)
...
+ Intégration avec d&#39;autres solutions {#integrating-with-adobe-cloud}
   ...
   + Campaign et Microsoft Dynamics 365 {#campaign-and-microsoft-dynamics-365}
      ...
      + Configuration de l&#39;application d&#39;intégration {#configure-integration-tool}
         ...
         + [Migration des informations d’identification de JWT vers OAuth Server-to-Server](integrating/using/d365-acs-self-service-app-migrate-credentials.md)
...
+ Administration {#administrating}
   ...
   + Configuration des canaux mobiles {#configuring-mobile}
      ...
      + [Modifications à venir du canal de notification push](administration/using/push-technote.md)
