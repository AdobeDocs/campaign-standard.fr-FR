...
Pour trouver les destinataires qui ont été affectés par ce problème, ou au cas où cela se reproduirait avec un autre FAI, veuillez consulter les instructions . [dans cette page](understanding-quarantine-management.md#unquarantine-bulk).
