...
* **Quelle est la différence entre une adresse email en liste bloquée et une adresse email mise en quarantaine ?**
...
## Retrait d’une adresse email de la liste bloquée {#removing-from-block-list}
