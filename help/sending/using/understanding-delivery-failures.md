...
Les messages d’erreur d’échec de remise (ou &quot;réponses de rebond SMTP&quot;) sont sélectionnés par la plateforme Adobe Campaign, puis traités et qualifiés comme **Dur**, **Soft** ou **Ignorés** à l’aide de la base de données de qualification du journal de **[!UICONTROL livraison.]**
