...
>[!IMPORTANT]
>
>Vérifiez que les profils contiennent une adresse postale car cette information est indispensable pour le fournisseur de courrier. Assurez-vous également que la case **[!UICONTROL Adresse renseignée]** est cochée dans les informations des profils. Voir [Recommandations](../../channels/using/about-direct-mail.md#recommendations).
...
L&#39;utilisation de pièges est essentielle pour les diffusions courrier. Ils permettent de vérifier que votre fournisseur de courrier envoie bien la communication et qu’il ne partage pas votre liste de clients avec un autre fournisseur. Voir [Utilisation de pièges](../../sending/using/using-traps.md).
