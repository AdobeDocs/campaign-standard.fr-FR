...
1. Sélectionnez l'action dans la liste déroulante du panneau de gauche. Les actions possibles sont les suivantes : **[!UICONTROL Actualiser]** (pour actualiser la page) et **[!UICONTROL Page suivante]** (pour afficher la page de confirmation).
...
1. Cliquez sur le bouton ![](assets/lp_link_properties.png) dans le panneau de gauche.
