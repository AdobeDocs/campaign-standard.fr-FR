...
1. Créez un email à partir de l&#39;un des trois modèles spécifiques à l&#39;A/B testing, en fonction de l&#39;élément que vous souhaitez faire varier :
   ...
   * Test A/B sur l&#39;objet
   ...
   >[!NOTE]
   >
   >Les modèles de relance et de test A/B sont masqués par défaut. Check the A/B test box on the left side (**[!UICONTROL Filter]** lateral panel) to display them.
...
1. A la quatrième étape de l&#39;assistant de création, définissez les paramètres du test A/B :
   ...
   * **[!UICONTROL Number of variants]**: Vous pouvez choisir d’utiliser deux ou trois variantes. Si vous choisissez trois variantes, ce choix n&#39;est plus modifiable après validation de cette étape de l&#39;assistant.
   * **[!UICONTROL Winning strategy]**: Sélectionnez le critère à utiliser pour déterminer la variante gagnante.
   * **[!UICONTROL Target breakdown]**: Choisissez le pourcentage du  de qui recevra chaque variante. Le pourcentage restant recevra la variante gagnante une fois qu&#39;elle sera déterminée. La sélection est réalisée aléatoirement parmi les profils de la cible.
   * **[!UICONTROL Winner sending method]**: Indiquez si vous souhaitez que la variante gagnante soit automatiquement envoyée une fois déterminée ou si vous souhaitez confirmer manuellement l’envoi à la population restante.
   * **[!UICONTROL Test duration]**: Spécifiez la durée du test. La variante gagnante est déterminée automatiquement à l&#39;issue de cette durée. Vous pouvez choisir manuellement la variante gagnante avant la fin du test depuis le tableau de bord de l&#39;email.
...
1. Vérifiez les paramètres de test A/B affichés dans le **[!UICONTROL A/B test parameters]** bloc. Vous pouvez les modifier jusqu&#39;à la confirmation de l&#39;envoi du test (étape 9) en sélectionnant le bloc.
...
1. Une fois la préparation terminée, confirmez l&#39;envoi du test. Après la confirmation, les paramètres de test A/B ne sont plus modifiables.
   ...
   The A/B test starts on the date defined in the **[!UICONTROL Schedule]**. Vous pouvez suivre sa progression à l’aide des **[!UICONTROL A/B test]** blocs et **[!UICONTROL Deployment]** .
...
Note that the **[!UICONTROL Estimated recipient reactivity]** indicator is a rate comparing the number of recipients who clicked against the number of recipients who opened the email. Par exemple, si 10 destinataires ont ouvert l&#39;email et si 5 d&#39;entre eux ont cliqué dessus, le taux de réactivité est de 50 %.
