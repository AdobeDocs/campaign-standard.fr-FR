...
* Compte **[!UICONTROL Routing]** externe configuré sur le **[!UICONTROL Mobile (SMS)]** canal avec le **[!UICONTROL Bulk delivery]** mode. Voir à ce propos la section [Routage](../../administration/using/configuring-sms-channel.md#defining-an-sms-routing).
