---
title: Guide Campaign Standard Mobile
description: Découvrez les directives générales concernant les diffusions mobiles dans Adobe Campaign Standard, telles que la configuration de vos applications mobiles ou la création de notifications push et de messages In-App.
audience: channels
...
<tr>
<td><img src="assets/do-not-localize/push2.png" width="60px"><p>En savoir plus sur la création de notifications push </br><a href="#create-push">Cliquez ici</a></p></td>
...
## A propos de la diffusion mobile {#about-mobile}
...
* SMS, présenté dans la section À propos des SMS .
* Notifications push, présentées dans la section À propos des notifications push .
* Messages In-App, présentés dans la section À propos des messages In-App .
...
<tr>
  ...
  <td>
    ...
    <p>En savoir plus sur la structure de la payload reçue dans les applications mobiles lorsqu’une notification push est envoyée à une application à partir d’Adobe Campaign Standard.</br><a href="../../administration/using/push-payload.md"><strong>Cliquez ici</strong></a> pour plus d'informations.</p>
    <br>
  </td>
</tr>
<tr>
  <td>
    ...
    <p>Découvrez ici comment vous assurer que le suivi des notifications locales a été correctement mis en oeuvre. </br><a href="../../administration/using/local-tracking.md"><strong>Cliquez ici</strong></a> pour plus d'informations.</p>
    <br>
  </td>
  <td>
    <div>
    <p><strong>Mise en oeuvre du suivi push</strong></p>
    </div>
    <p>Découvrez comment vous assurer que le suivi des notifications push a été correctement mis en oeuvre sur iOS et Android.</br><a href="../../administration/using/push-tracking.md"><strong>Cliquez ici</strong></a> pour plus d'informations.</p>
    <br>
  </td>
</tr>
</table>
...
<tr>
  ...
  <td>
    ...
    <p>En savoir plus sur les cas pratiques mobiles pris en charge dans Adobe Campaign Standard à l’aide des SDK Adobe Experience Platform.</br><a href="../../administration/using/supported-mobile-use-cases.md"><strong>Cliquez ici</strong></a> pour plus d'informations.</p>
    <br>
  </td>
</tr>
<tr>
  <td>
    ...
    <p><a href="../../administration/using/configuring-rules-launch.md"><strong>Cliquez </strong></a> ici pour commencer à créer des éléments de données et des règles dans Adobe Experience Platform Launch afin d'envoyer des informations d'identification personnelles et d'autres données des applications mobiles vers Adobe Campaign Standard.</p>
    <br>
  </td>
  <td>
    <div>
...
## Créez une notification push {#create-push}
...
<tr>
  <td>
    ...
    <p><a href="../../channels/using/preparing-and-sending-a-push-notification.md"><strong>Découvrez </strong></a> comment préparer votre notification push puis comment l'envoyer à votre audience ciblée.</p>
    <br>
  </td>
  <td>
    <div>
    <p><strong>Personnaliser une notification push</strong></p>
    </div>
    <p>Pour affiner votre diffusion, Adobe Campaign vous permet d'accéder à un ensemble d'options lors de la conception d'une notification push.</br><a href="../../channels/using/customizing-a-push-notification.md"><strong>Cliquez ici</strong></a> pour plus d'informations.</p>
    <br>
  </td>
</tr>
<tr>
...
<tr>
  <td>
    ...
    <p><a href="../../channels/using/preparing-and-sending-an-in-app-message.md"><strong>Découvrez </strong></a> comment préparer vos messages In-App puis comment les envoyer à votre audience ciblée.</p>
    <br>
  </td>
  <td>
    <div>
    ...
    <p>Pour affiner votre diffusion, Adobe Campaign vous permet d'accéder à un ensemble d'options avancées lors de la conception d'un message In-App.</br><a href="../../channels/using/customizing-an-in-app-message.md"><strong>Cliquez ici</strong></a> pour plus d'informations.</p>
    <br>
  </td>
</tr>
<tr>
  <td>
    <div>
    <p><strong>Personnaliser un type de message de notification locale      </strong></p>
    </div>
...
<tr>
  <td>
    ...
    <p>La création d'une diffusion SMS est très similaire à celle d'un email classique. </br>Les étapes  <a href="../../channels/using/creating-an-sms-message.md"><strong>détaillées </strong></a> ci-dessous décrivent la configuration spécifique à ce canal.</br></p>
    <br>
  </td>
  <td>
    <div>
    ...
    <p>Pour affiner votre diffusion, Adobe Campaign vous permet d'accéder à un ensemble d'options avancées lors de la conception d'un SMS.</br><a href="../../channels/using/sms-and-push-content-editor-interface.md"><strong>Cliquez ici pour plus d'informations.</br><a href="../../channels/using/sms-and-push-content-editor-interface.md"><strong></p>
    <br>
  </td>
</tr>
<tr>
  <td>
    <div>
    <p><strong>Gérer les SMS entrants</strong></p>
    </div>
...
## Dépannage mobile {#mobile-troubleshooting}

Les pages suivantes vous aideront à résoudre les problèmes les plus courants qui se produisent lors de l’utilisation de la diffusion mobile dans Adobe Campaign Classic.
