---
title: Configuration d’une page d’entrée
description: Découvrez comment configurer les propriétés d’une page d’entrée.
...
## Liaison d’une page d’entrée à un service {#linking-a-landing-page-to-a-service}
