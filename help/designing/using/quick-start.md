...
1. Adaptez les options de style à votre contenu, si nécessaire. Pour plus d&#39;informations, consultez la section [Modifier les styles d’un email](../../designing/using/styles.md).
