...
description: Découvrez comment utiliser les listes de produits dans un contenu message transactionnel.
audience: designing
...
>[!IMPORTANT]
>
>Les listes de produits sont disponibles uniquement pour **les messages électroniques transactionnels** via l&#39;interface [E-mail Designer](../../designing/using/designing-content-in-adobe-campaign.md#email-designer-interface).
