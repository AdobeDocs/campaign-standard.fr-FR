...
Les états des tâches d&#39;assimilation de données sont les suivants :
...
Dans certains cas, vous pouvez obtenir l’erreur de validation ci-dessous lors de la publication de votre mappage.
...
1. Accédez au jeu de données sur Adobe Experience Platform à l’aide du lien présent sur la page de mappage XDM.

1. Accédez à votre schéma XDM.

1. Ajoutez le mixin &quot;Protection de la vie privée&quot; au schéma.

   ![](assets/aep_datamapping_privacyfield.png)

1. Enregistrez le schéma, puis réessayez de publier le mappage. La publication devrait maintenant être approuvée.
