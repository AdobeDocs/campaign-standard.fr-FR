...
Pour découvrir comment créer des demandes d’**Accès** et de **Suppression**, et comment elles sont traitées par Adobe Campaign, consultez la section [Étapes de mise en œuvre](../../start/using/privacy-requests.md#about-privacy-requests).
