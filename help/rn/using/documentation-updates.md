...
Validation des landing pages : vous pouvez désormais ajouter une option de contrat obligatoire à vos landing pages. [En savoir plus](../../channels/using/managing-landing-page-form-data.md#agreement-checkbox)

La section **Taille de l’email** a été mise à jour avec des informations sur la taille maximale d’un email, qui est désormais définie sur 100 Mo par défaut. [En savoir plus](../../sending/using/design-and-personalize.md#email-size)

**Autres mises à jour de la documentation accompagnant cette version**

Ajout d’informations sur la modification du mapping de ciblage dans une notification push transactionnelle - [En savoir plus](../../channels/using/transactional-push-notifications.md#change-target-mapping)
