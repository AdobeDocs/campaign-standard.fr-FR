...
La section Confidentialité a été déplacée et enrichie de deux nouvelles pages : [Gestion de la confidentialité](../../start/using/privacy-management.md) et [Gestion des demandes d&#39;accès à ds informations personnelles](../../start/using/privacy-requests.md).

Des informations ont été ajoutées dans la section Connecteur de données Adobe Experience Platform sur l’erreur de validation du mappage de données liée à la gestion de la confidentialité et sur la manière de la résoudre. [En savoir plus](../../developing/using/aep-mapping-activation.md)

La section Données personnelles et Personas a été mise à jour avec un scénario d’utilisation afin d’illustrer comment les différentes personnes interagissent en matière de confidentialité. [En savoir plus](../../start/using/privacy.md#use-case-scenario)

Une nouvelle section énumérant les questions fréquentes sur la protection des renseignements personnels a été ajoutée. [En savoir plus](../../start/using/privacy-faq.md)
...
Une section a été ajoutée pour décrire les nouveaux filtres qui permettent de rechercher les configurations des événements en fonction de leur statut et de la dernière réception d&#39;un événement. [En savoir plus](../../administration/using/configuring-transactional-messaging.md#searching-transactional-events)
...
La section Paramètres du canal email a été clarifiée avec des informations supplémentaires sur les champs de masques autorisés et l’identifiant des rapports de délivrabilité – [En savoir plus](../../administration/using/configuring-email-channel.md)
...
Un cas d’utilisation a été ajouté pour vous permettre de convertir les e-mails de l’ancien éditeur dans le Concepteur d’email – [En savoir plus](../../designing/using/converting-emails-from-legacy-editor.md)
...
Disponibilité d’une nouvelle section décrivant comment supprimer une configuration d’événement – [En savoir plus](../../administration/using/configuring-transactional-messaging.md#deleting-an-event)
...
Déplacement et mise à jour de la section consacrée à l’archivage avec Email BCC – [En savoir plus](../../sending/using/archiving.md)
...
Mise à jour de la documentation sur le Concepteur d’email de Campaign et des pages connexes pour prendre en compte l’obsolescence du [!DNL Adobe Creative SDK]. [En savoir plus](https://helpx.adobe.com/fr/campaign/kb/acs-deprecated-and-removed-features.html)
...
Cette [page](https://docs.adobe.com/content/help/fr-FR/campaign-standard-learn/tutorials/overview.html) devient la page officielle des vidéos d’Adobe Campaign Standard.
...
Intégration de Dreamweaver disponible – [En savoir plus](https://docs.adobe.com/content/help/fr-FR/campaign-standard-learn/tutorials/designing-content/email-designer/dreamweaver-integration.html)
