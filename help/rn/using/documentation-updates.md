...
Une nouvelle section a été consacrée à la manière d’utiliser les sources et destinations Adobe Experience Platform pour partager des données entre les Campaign Standards et les Adobes de la plateforme de données client en temps réel (RTCDP). [En savoir plus](../../integrating/using/get-started-sources-destinations.md)

## Mars 2021 {#doc-updates-march-2021}

La page « Options d’aide et d’assistance » pour Campaign Standard a été intégrée dans la documentation de base. [En savoir plus](../../support.md)
