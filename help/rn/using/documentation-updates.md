...
**Amélioration incluse dans la version**
...
Les intégrations avec Adobe Experience Platform Data Connector et le service Audience Destinations sont désormais obsolètes. [En savoir plus](deprecated-features.md)
