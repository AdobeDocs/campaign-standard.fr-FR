...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Il est désormais possible de déclencher une activité Signal pour vos workflows directement depuis l'API Adobe Campaign Standard.<br /> Pour plus d'informations, consultez la <a class="anchorLink" href="../../api/using/managing-workflows.md">documentation détaillée</a> .<br /> </td> 
  </tr> 
 </tbody> 
</table>
