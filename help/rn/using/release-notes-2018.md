...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Il est désormais possible de déclencher une activité Signal pour vos workflows directement depuis l'API Adobe Campaign Standard.<br /> Pour plus d'informations, consultez la <a class="anchorLink" href="https://final-docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#triggering-a-signal-activity" target="_blank">documentation détaillée</a> .<br /> </td> 
  </tr> 
 </tbody> 
</table>
