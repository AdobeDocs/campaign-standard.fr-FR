...
![Panneau de contrôle](assets/do-not-localize/cp-icon.png) **Nouvelles versions du panneau de contrôle** avec surveillance des débits, de la latence et des workflows. [En savoir plus](https://experienceleague.adobe.com/docs/control-panel/using/release-notes.html?lang=fr){target=&quot;_blank&quot;}.
