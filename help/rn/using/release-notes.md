...
![Panneau de Contrôle](assets/do-not-localize/cp-icon.png) **Nouvelle version de Panneau de Contrôle**. [En savoir plus](https://experienceleague.adobe.com/docs/control-panel/using/release-notes.html?lang=fr){target=&quot;_blank&quot;}.
