...
1. Donnez un **[!UICONTROL Libellé]** et un **Identifiant]à votre événement.[!UICONTROL ** Le champ **[!UICONTROL Identifiant]est obligatoire et doit commencer par le préfixe "EVT".** Si vous n'utilisez pas ce préfixe, il est automatiquement ajouté lorsque vous cliquez sur **[!UICONTROL Créer]**.
...
1. Dans la section **[!UICONTROL Collections]**, cliquez sur le bouton **Créer un élément[!UICONTROL .]**
...
Il est possible d'enrichir le contenu du message transactionnel avec des informations des ressources étendues **[!UICONTROL Profil]** ou **Service[!UICONTROL .]**

Ces informations peuvent également être stockées dans de nouvelles ressources. Le cas échéant, la ressource doit être liée aux ressources **[!UICONTROL Profil]** ou **Service]soit directement, soit via une autre table.[!UICONTROL ** Par exemple, dans la configuration ci-dessous, il est possible d'enrichir le contenu d'un message transactionnel avec des informations de la ressource **[!UICONTROL Produit]**, telles que la catégorie de produit ou l'identifiant, si la ressource **[!UICONTROL Produit]est liée à la ressource** Profil **.**
...
1. Dans cet exemple, nous réconcilions les champs **[!UICONTROL Nom]** et **[!UICONTROL Prénom]avec les champs correspondants dans la ressource** Profil **.**
...
1. Prévisualisez et publiez l'événement (voir [Prévisualiser et publier l'événement](../../administration/using/configuring-transactional-messaging.md#previewing-and-publishing-the-event)).
   ...
   Une fois la publication effectuée, une notification push transactionnelle associée au nouvel événement est automatiquement créée. To modify and publish the message that was just created, see [Sending a transactional push notification targeting an event](/channels/using/transactional-push-notifications.html#sending-a-transactional-push-notification-targeting-an
