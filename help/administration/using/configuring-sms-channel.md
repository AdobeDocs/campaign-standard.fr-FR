...
1. Définissez les paramètres de **[!UICONTROL Débit et délais d’expiration]**.
...
1. Si besoin, définissez des réponses automatiques pour déclencher des actions selon le contenu de celles-ci. Pour plus d’informations, consultez [cette section](../../channels/using/managing-incoming-sms.md#managing-stop-sms).
...
>[!NOTE]
>
>Le mapping entre la valeur **data_coding** et l’encodage réellement utilisé est standardisé. Cependant, certains SMSC possèdent une correspondance qui leur est propre : dans ce cas, votre administrateur **Adobe Campaign** doit déclarer cette correspondance. Consultez votre fournisseur pour en savoir plus.
...
* Le champ **[!UICONTROL Mode de transmission]** permet de déterminer la méthode de diffusion des messages par SMS :
   ...
   * **[!UICONTROL Enregistré sur mobile]** : le message est stocké dans la mémoire interne du téléphone.
