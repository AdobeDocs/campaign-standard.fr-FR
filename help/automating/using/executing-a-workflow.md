...
* **[!UICONTROL Jours d’historique]** : indique le nombre de jours après lesquels l’historique doit être purgé. L’historique se compose de tous les éléments associés comme les logs, les tâches, les événements. La valeur par défaut est de 30 jours pour les modèles de workflow d’usine.
