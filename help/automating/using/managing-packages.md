...
Packages are available under the **[!UICONTROL Administration]** &gt; **[!UICONTROL Deployment]** &gt; **[!UICONTROL Package exports]** or **[!UICONTROL Package imports]** menus. Les deux menus ont un comportement similaire.
...
* Le package **[!UICONTROL Plate-forme]** regroupe toutes les ressources ajoutées pendant la configuration technique : ressources personnalisées, ensembles de ressources personnalisées, triggers et options d'application de type **Système[!UICONTROL .]**
...
1. Dans l'onglet **** Définition de l'export], utilisez le bouton **[!UICONTROL Créer un élément]pour sélectionner les ressources que vous souhaitez exporter.[!UICONTROL **
...
>[!NOTE]
>
>Lorsque vous sélectionnez, à partir de la liste des définitions de package, un élément qui a déjà été exporté, les onglets **[!UICONTROL Journal]** et **Dernier export]sont toujours disponibles.[!UICONTROL **
