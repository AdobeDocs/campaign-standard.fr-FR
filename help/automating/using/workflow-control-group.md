...
# Création d’un groupe témoin {#building-control-group}
...
1. Effectuez un glisser-déposer d&#39;une activité [Mise à jour de données](../../automating/using/update-data.md) après le segment du groupe témoin.
